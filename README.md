# Kemijärvi Proof-of-Concept
Game for Android set in Kemijärvi area where you play as a postman delivering packages to different characters in the city. Virtual version of Kemijärvi is created using the VirtualCity-tool. Game also features an AR-mode where you can navigate through the city in AR-mode seeing point of interests on the way.
